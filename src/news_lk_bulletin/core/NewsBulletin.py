...
class NewsBulletin:
    ...
    def system_cmd(self) -> str:
        return ' '.join(
            [
                ...
                'EXCLUDE include news that does not reference Sri Lanka'
                + '/something Sri Lankan.',
                'PRIORITIZE news that might be of practical use.',
                'DO NOT repeat facts.',
                'EXCLUDE marketing/propaganda.',
                'DO mention the name of the source, briefly as "[newspaper]".',
                'EMPHASIZE entities and statistics.',
    ...
    def all_lines(self) -> list[str]:
        ...
        return [
            ...
            '## Methodology',
            '',
            'This bulletin has been autogenerated by'

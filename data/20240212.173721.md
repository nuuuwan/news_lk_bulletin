...
*Updated* **2024-02-12 17:37:21**

1. **Sanath Nishantha**, the former state minister, was involved in a collision with a container vehicle. The driver of the container has given a 5-hour statement to the police, who are investigating the incident. Nishantha's wife has demanded a formal investigation into the incident [adaderanasinhalalk].
2. The **Ceylon Petroleum Storage Terminal** has signed an agreement for the storage and distribution of fuel. The agreement was made following instructions from Power and Energy Kanchana Wijesekara to improve fuel distribution [adaderanasinhalalk].
3. Seven senior students from **Sabaragamuwa University** have been arrested in connection with an attack on a second-year student. The students were remanded until the following day [virakesarilk].
4. A complaint has been

</div>

## Source News

Based on **47** News Articles, from the last **4** hours.

...
2. **Imran Khan**, former prime minister of Pakistan, has been granted bail in 12 cases involving attacks on military installations. 🇵🇰⚖️
3. A cleaning staffer at **Bandaranaike International Airport (BIA)** was arrested with gold jewelry and gold in gel form worth around Rs. 58 million. 💰👮‍♀️
4. **Sri Lanka Transport Board (SLTB)** has added 200 renovated buses to its fleet. 🚌🚏
5. **Adani Group** is in talks with Sri Lankan authorities to manage three airports in the country, including Bandaranaike International Airport. 🇮🇳✈️
6. **Tamil Nadu Chief Minister MK Stalin** has written to Indian Prime Minister Narendra Modi, expressing concern about the rising number of attacks on fishermen from the state by unidentified persons. 🎣🇱🇰
7. **Sri Lanka Cricket (SLC)** will facilitate the Uganda national cricket team for a 14-day training camp. 🏏🇺🇬
...
9. **Sri Lanka’s tourist arrivals** crossed the 60,000 mark in the first week of February, indicating improved interest in the destination. 🏖️📊
10. **Water supply** for parts of Colombo will be suspended for 15 hours from 5:00 p.m. today due to essential maintenance work. 💧🚧
